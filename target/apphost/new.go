...
func (f Factory) NewAdapter(ctx context.Context, portal target.Base) target.Apphost {
...
func (f Factory) WithTimeout(ctx context.Context, portal target.Base) target.Apphost {
