...
To install **Portal Environment** [obtain a copy of](https://github.com/cryptopunkscc/portal/releases) `portal-installer`, and execute it from command line:
...
Add the following line to the user's environment variable `Path`:
